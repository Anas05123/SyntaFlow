...
Read [`AGENTS.md`](file:///c:/Users/Anas/Desktop/CoreDesk/AGENTS.md) first.

Use [`docs/README.md`](file:///c:/Users/Anas/Desktop/CoreDesk/docs/README.md) to route context.

Do not scan the entire repository unless the task genuinely requires it.
Load only the designated skill from `skills/` relevant to your assigned task.
