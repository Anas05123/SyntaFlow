...
const STAGES: StageNode[] = [
  {
    ...
    statusColor: '#06B6D4',
    icon: '✉',
    headline: 'Inbound communications attached directly to the client record.',
  ...
  },
  {
    ...
    statusColor: '#8B5CF6',
    icon: '◫',
    headline: 'Breakdown of work packages into dual-density task boards.',
