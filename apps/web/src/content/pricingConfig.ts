...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    description: 'Advanced automation, multi-device encrypted sync, and continuous workspace context for power users.',
    featured: false,
    status: 'planned',
    ctaLabel: 'Notify Me',
    ctaAction: 'notify',
    features: [
      ...
      'End-to-end encrypted multi-device database sync',
      'Priority cloud sync & backup snapshots',
      'Advanced AI synthesis across multi-project portfolios',
      'Custom blueprint creation & custom domain review links',
      'Automated client check-in & milestone notification rails',
      'Enhanced audit logging & export capabilities',
      'Perpetual license or optional cloud sync subscription',
    ],
  },
  {
    id: 'team',
